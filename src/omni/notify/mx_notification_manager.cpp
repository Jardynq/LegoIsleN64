...
MxNotificationManager::MxNotificationManager() : MxCore(), m_listenerIds() {
	m_unk0x2c = 0;
	m_queue = NULL;
	m_active = TRUE;
	m_sendList = NULL;
...
MxResult MxNotificationManager::
	Create(MxU32 /*p_frequencyMS*/, MxBool /*p_createThread*/) {
