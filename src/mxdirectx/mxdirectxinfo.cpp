...
BOOL MxDeviceEnumerate::EnumDirectDrawCallback(
	LPGUID p_guid,
	LPSTR p_driverDesc,
	LPSTR p_driverName
) {
...
HRESULT MxDeviceEnumerate::EnumDisplayModesCallback(LPDDSURFACEDESC p_ddsd) {
	...
	MxDisplayMode displayMode(
		p_ddsd->dwWidth,
		p_ddsd->dwHeight,
		p_ddsd->ddpfPixelFormat.dwRGBBitCount
	);
...
HRESULT MxDeviceEnumerate::EnumDevicesCallback(
	...
	Direct3DDeviceInfo
		device(p_guid, p_deviceDesc, p_deviceName, p_HWDesc, p_HELDesc);
...
BOOL CALLBACK MxDeviceEnumerate::DirectDrawEnumerateCallback(
	LPGUID p_guid,
	LPSTR p_driverDesc,
	LPSTR p_driverName,
	LPVOID p_context
	...
	return ((MxDeviceEnumerate*) p_context)
		->EnumDirectDrawCallback(p_guid, p_driverDesc, p_driverName);
}
