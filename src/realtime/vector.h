...
protected:
	...
	DotImpl(const float* p_a, const float* p_b) const;   // vtable+0x18
...
public:
	...
	inline virtual float
	Dot(const float* p_a, const float* p_b) const; // vtable+0x3c
	inline virtual float
	Dot(const Vector2& p_a, const Vector2& p_b) const; // vtable+0x38
	inline virtual float
	Dot(const float* p_a, const Vector2& p_b) const; // vtable+0x34
	inline virtual float
	Dot(const Vector2& p_a, const float* p_b) const;        // vtable+0x30
...
protected:
	...
	inline float
	DotImpl(const float* p_a, const float* p_b) const override; // vtable+0x18
	inline void EqualsImpl(const float* p_data) override;       // vtable+0x20
	inline virtual void
	EqualsCrossImpl(const float* p_a, const float* p_b); // vtable+0x74
...
public:
	...
	inline virtual void
	EqualsCross(const Vector3& p_a, const Vector3& p_b); // vtable+0x80
	inline virtual void
	EqualsCross(const Vector3& p_a, const float* p_b); // vtable+0x7c
	inline virtual void
	EqualsCross(const float* p_a, const Vector3& p_b); // vtable+0x78
...
public:
	...
	inline virtual void
	SetMatrixProduct(const float* p_vec, const float* p_mat); // vtable+0x8c
	inline virtual void
	SetMatrixProduct(const Vector4& p_a, const float* p_b); // vtable+0x88
	inline virtual int NormalizeQuaternion();               // vtable+0x90
	inline virtual int EqualsHamiltonProduct(
		const Vector4& p_a,
		const Vector4& p_b
	); // vtable+0x94
