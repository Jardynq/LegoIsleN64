...
public:
	...
	static const char* ClassName() { return "AnimState"; }
...
public:
	...
	static const char* ClassName() { return "LegoAnimationManager"; }
	...
	static void
	configureLegoAnimationManager(MxS32 p_legoAnimationManagerConfig);
